private _units = AllUnits select {isPlayer _x == false};
onEachFrame{};
{
	...
	private _group = CreateGroup west;
	{
		...
		sleep 0.01;
		[_unit,[profileNamespace,format["%1:%2: %3",_factionName,_editorSubCatName,getText (_x >> "displayName")]],[],true] call BIS_fnc_SaveInventory;
		deleteVehicle _unit;
	}
	foreach _config;
}
